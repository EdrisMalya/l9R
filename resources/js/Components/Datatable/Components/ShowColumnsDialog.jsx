...
import {DialogActions, DialogContent, FormControlLabel, Switch} from "@mui/material"
        ...
        <Dialog onClose={handleClose} open={open}>
            ...
            <DialogContent>
                {props.showNumber && (
                    <div>
                        <FormControlLabel
                            control={<Switch checked={isChecked('increment')} />}
...
export default function ShowColumnsDialog({translate, columns, data, dispatch, actions, showNumber}) {
    ...
    return (
        <div>
            <Button endIcon={<FunnelIcon className={'h-4'} /> } variant="outlined" onClick={handleClickOpen}>
